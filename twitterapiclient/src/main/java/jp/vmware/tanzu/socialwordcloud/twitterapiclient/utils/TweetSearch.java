...
public interface TweetSearch {
	...
	Set<String> tweetFields = new HashSet<>(Arrays.asList("author_id", "id", "created_at", "lang", "geo"));

	Set<String> expansions = new HashSet<>(List.of("author_id"));

	Set<String> userFields = new HashSet<>(Arrays.asList("name", "username", "location"));
